...
class PhotoBoxThree extends StatefulWidget {
  final double width;
  final double height;
  ...
  @override
  _PhotoBoxThreeState createState() => _PhotoBoxThreeState();
}

class _PhotoBoxThreeState extends State<PhotoBoxThree> {
  File imageFile;
  UserModel userModel;
      ...
      child: Padding(
        ...
        child: Container(
          decoration: BoxDecoration(
              ...
              color: (userModel.img3 == null || userModel.img3 == "default-user-profile-image.png") ? Colors.white : Colors.grey[100]),
          child: (userModel.img3 == null || userModel.img3 == "default-user-profile-image.png")
                  ...
                  children: <Widget>[
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        imageUrl: Constants.USERS_PROFILES_URL + userModel.img3,
                        fit: BoxFit.cover,
                        placeholder: (d, d2) {
                          return Center(
                            child: Container(
  ...
  print("workingggggggggggggggggggggggggggggggggggggggg");
    ...
    String _url = '${Constants.SERVER_URL}user/img3';
  ...
  void startDeleteImg() async {
    ...
    try {
      var response = await http.post(
        '${Constants.SERVER_URL}user/remUserImg3',
        body: {
          'user_id': userModel.id,
        },
      );
