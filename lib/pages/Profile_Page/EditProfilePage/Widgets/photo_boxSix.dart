...
class PhotoBoxSix extends StatefulWidget {
  final double width;
  final double height;
  ...
  @override
  _PhotoBoxSixState createState() => _PhotoBoxSixState();
}

class _PhotoBoxSixState extends State<PhotoBoxSix> {
  File imageFile;
  UserModel userModel;
      ...
      child: Padding(
        ...
        child: Container(
          decoration: BoxDecoration(
              ...
              color: (userModel.img6 == null || userModel.img6 == "default-user-profile-image.png") ? Colors.white : Colors.grey[100]),
          child: (userModel.img6 == null || userModel.img6 == "default-user-profile-image.png")
              ...
              : Stack(
                  ...
                  children: <Widget>[
                    InkWell(
                      onTap: (){
                        print(userModel.img6);
                      },
                                          child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Container(
                          child: isDeleteImgFinished? CachedNetworkImage(
                          imageUrl: Constants.USERS_PROFILES_URL + userModel.img6,
                          fit: BoxFit.cover,
                          placeholder: (d, d2) {
                            return Center(
                              child: Container(
  ...
  print("workingggggggggggggggggggggggggggggggggggggggg");
   ...
   void startUplodImg(File imageFile) async{
    String _url = '${Constants.SERVER_URL}user/img6';
  ...
  void startDeleteImg() async {
    ...
    try {
      var response = await http.post(
        '${Constants.SERVER_URL}user/remUserImg6',
        body: {
          'user_id': userModel.id,
        },
      );
