...
class PhotoBoxTwo extends StatefulWidget {
  final double width;
  final double height;
  ...
  @override
  _PhotoBoxTwoState createState() => _PhotoBoxTwoState();
}

class _PhotoBoxTwoState extends State<PhotoBoxTwo> {
  File imageFile;
  UserModel userModel;
 bool isUploadFnished2 = true;
  bool isDeleteImgFinished2 = true;
  ...
  void initState() {
    ...
    setState(() {
      isUploadFnished2 = true;
      isDeleteImgFinished2 = true;
    });
    super.initState();
  }
      ...
      child: Padding(
        ...
        child: Container(
          decoration: BoxDecoration(
              ...
              color: (userModel.img2 == null || userModel.img2 == "default-user-profile-image.png") ? Colors.white : Colors.grey[100]),
          child: (userModel.img2 == null || userModel.img2 == "default-user-profile-image.png")
              //No img selected and camera logo is shown
              ? isUploadFnished2 ? ClipRRect(
              ...
              : Stack(
                  ...
                  children: <Widget>[
                    ClipRRect(
                      borderRadius: BorderRadius.circular(10),
                      child: Container(
                        child: isDeleteImgFinished2? CachedNetworkImage(
                        imageUrl: Constants.USERS_PROFILES_URL + userModel.img2,
                        fit: BoxFit.cover,
                        placeholder: (d, d2) {
                          return Center(
                            child: Container(
  ...
  _openCamera(BuildContext context,int type) async {
    ...
    if(imageFile != null){
     ...
     print("upload state status - " + isUploadFnished2.toString());
      _cropImage(imageFile);
    }
    Navigator.of(context).pop();
  }
  ...
  print("workingggggggggggggggggggggggggggggggggggggggg");
    ...
    String _url = '${Constants.SERVER_URL}user/img2';
  ...
  void startDeleteImg() async {
    ...
    setState(() {
      isDeleteImgFinished2 = false;
    });
    try {
      var response = await http.post(
        '${Constants.SERVER_URL}user/remUserImg2',
        body: {
          'user_id': userModel.id,
        },
      );
