...
class PhotoBoxFour extends StatefulWidget {
  final double width;
  final double height;
  ...
  @override
  _PhotoBoxFourState createState() => _PhotoBoxFourState();
}

class _PhotoBoxFourState extends State<PhotoBoxFour> {
  File imageFile;
  UserModel userModel;
 bool isUploadFnished = true;
      ...
      child: Padding(
        ...
        child: Container(
          decoration: BoxDecoration(
              ...
              color: (userModel.img4 == null|| userModel.img4 == "default-user-profile-image.png") ? Colors.white : Colors.grey[100]),
          child: (userModel.img4 == null || userModel.img4 == "default-user-profile-image.png")
                  ...
                  children: <Widget>[
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        imageUrl: Constants.USERS_PROFILES_URL + userModel.img4,
                        fit: BoxFit.cover,
                        placeholder: (d, d2) {
                          return Center(
                            child: Container(
  ...
  print("workingggggggggggggggggggggggggggggggggggggggg");
   ...
   void startUplodImg(File imageFile) async{
    ...
    String _url = '${Constants.SERVER_URL}user/img4';
   ...
   setState(() {
    ...
    try {
      var response = await http.post(
        '${Constants.SERVER_URL}user/remUserImg4',
        body: {
          'user_id': userModel.id,
        },
      );
